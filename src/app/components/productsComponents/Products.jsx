...
const FetchProduct = async ({ Category }) => {
  ...
  return products.map((product) => (
    <div className="relative z-10 group" key={product.id}>
      <Link href={`/detail/${product.id}`} className="relative z-10 ">
        <div
          ...
          text-secondary shadow-xl  pb-3 overflow-hidden"
        >
          <div className="grid grid-cols-1 [&>*]:col-start-1 [&>*]:row-start-1 col-start-1! col-span-full">
            <h3 className="text-primary p-4 text-base font-bold absolute uppercase">{ product.category}</h3>
          ...
          <div className="grid grid-cols-[1fr_auto] gap-4 py-4 min-w-0">
            <div className="min-w-0">
              ...
              <span className="flex flex-nowrap gap-1 border-b-1  mt-2">
